...
app.use((req, res, next) => {
    res.header('Access-Control-Allow-Origin', 'https://jumadam.com');
...
app.get('/design', requireLogin, (req, res) => {
    res.sendFile(path.join(__dirname, 'public', 'design.html'));
});

app.get('/home_design', requireLogin, (req, res) => {
...
app.get('/getAnswers', requireLogin, async (req, res) => {
    console.log('GetAnswers request received');
    try {
